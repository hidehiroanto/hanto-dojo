...
def challenge_get():
    ...
    if not expression:
        return flask.render_template_string(html_template, flag=flag)
    ...
    return flask.render_template_string(html_template.replace('result', escaped_expression), flag=flag, expression=escaped_expression)
